    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WerhouseId = table.Column<int>(nullable: false),
                    GoodsId = table.Column<int>(nullable: false),
                    WarehouseId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Warehouse_Goods", x => new { x.GoodsId, x.WerhouseId });
                    table.ForeignKey(
                        name: "FK_Warehouse_Goods_Goods_GoodsId",
                        column: x => x.GoodsId,
                        principalTable: "Goods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Warehouse_Goods_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouse_Goods_WarehouseId",
